...
export const posts = [
    ...
    { id: "ssr-ssg", title: "SSR vs SSG", content: "서버사이드 렌더링과 정적 사이트 성생의 차이를 알아봅니다.", likes: 0 },
    { id: "dynamic-routes", title: "동적 라우팅", content: "Next.js에서 [slug]를 활용한 라우팅 방식입니다.", likes: 1 }
]